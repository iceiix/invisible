...
impl SunModel {
    ...
    pub fn generate_moon(renderer: &mut render::Renderer, phase: i32) -> model::ModelKey {
        ...
        renderer.model.create_model(
            model::SUN,
            vec![vec![
                model::Vertex{x: 0.0, y: -SIZE, z: -SIZE, texture_x: mpx, texture_y: mpy + (1.0 / 2.0), r: 255, g: 255, b: 255, a: 0, id: 0},
                model::Vertex{x: 0.0, y: SIZE, z: -SIZE, texture_x: mpx, texture_y: mpy, r: 255, g: 255, b: 255, a: 0, id: 0},
                model::Vertex{x: 0.0, y: -SIZE, z: SIZE, texture_x: mpx + (1.0 / 4.0), texture_y: mpy + (1.0 / 2.0), r: 255, g: 255, b: 255, a: 0, id: 0},
                model::Vertex{x: 0.0, y: SIZE, z: SIZE, texture_x: mpx + (1.0 / 4.0), texture_y: mpy, r: 255, g: 255, b: 255, a: 0, id: 0}
            ]]
        )
    }
}
